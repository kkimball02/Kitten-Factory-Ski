...
from .views import RawMaterialListCreateAPIView, RawMaterialRetrieveUpdateDestroyAPIView
...
urlpatterns = [
    ...
    path('api/product', ProductListCreateAPIView.as_view(), name='product'),
    ...
    path('order_history/', views.order_history_view, name='order-history')
]
